...
kernel_json = {
    "argv": [sys.executable, "-m", "formula_kernel", "-f", "{connection_file}"],
    "display_name": "Formula 2.0",
    "language": "python",
}
...
def install_my_kernel_spec(user=True, prefix=None):
    with TemporaryDirectory() as td:
        ...
        KernelSpecManager().install_kernel_spec(td, 'formula', user=user, prefix=prefix)
